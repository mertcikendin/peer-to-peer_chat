...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityMessageBinding.ivProfileAddFriend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void sendFriendshipRequest() {
        ...
        databaseReference.push().setValue(userMap).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(MessageActivity.this, "Arkadaşlık isteği başarıyla gönderildi", Toast.LENGTH_LONG).show();
            }
